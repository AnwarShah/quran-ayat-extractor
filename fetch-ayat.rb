...
begin
    ...
    sura_ayat = [2, [72,85,149,150,191,243], 3,[27], 4,[75], 5,[22,23,24,25], 6,[93,95], 7,[13, 18, 25, 58, 82], 9, [57, 64], 10,[31], 14,[13], 15, [34], 16,[69,78], 20, [55], 22, [22], 23,[35, 106,107], 24, [53], 26,[57, 167], 27, [37,67], 28,[20,21], 30, [19,25], 35, [37], 36, [33], 34, [2], 40, [11], 43, [11], 47, [13,29], 48,[22], 50, [42], 51,[35], 54,[7, 54], 55, [22], 59, [2], 63, [8], 65, [2], 70,[43], 71,[18], 84, [1,2,3,4,5],86, [7], 99,[2]]

    stm = db.prepare "SELECT Text FROM VERSES WHERE sura = :sura AND ayah = :ayah"

    sura_ayat.each_slice(2) do |sura, ayats|
